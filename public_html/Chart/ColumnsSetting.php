...
case '28':
	foreach ($AnswerListArray[$questionID] as $question_range_answerID => $theAnswerArray) {
		$theLabel[] = iconv('gbk', 'UTF-8', qcrossqtnname($theAnswerArray['optionAnswer']));
	}
...
$EnableQCoreClass->setTemplateFile('AmColumnsSettingFile', 'AmColumnsSetting.xml');
...
$EnableQCoreClass->set_CycBlock('AmColumnsSettingFile', 'LABEL', 'label');
...
$AmColumnsSetting = $EnableQCoreClass->parse('AmColumnsSetting', 'AmColumnsSettingFile');
unset($theLabel);
echo $AmColumnsSetting;
exit();
