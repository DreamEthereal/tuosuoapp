...
$thisProg = 'ShowQtnAssociateList.php?surveyID=' . $_GET['surveyID'] . '&surveyTitle=' . urlencode($_GET['surveyTitle']);
...
$EnableQCoreClass->setTemplateFile('SurveyAssFile', 'SurveyQtnAssociateList.html');
