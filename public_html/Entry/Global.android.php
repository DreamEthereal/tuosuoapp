...
switch (strtolower(trim($_GET['qlang']))) {
case 'cn':
default:
	$language = 'CN';
	break;
...
include_once ROOT_PATH . 'Lang/' . $language . '/Lang.fore.inc.php';
$EnableQCoreClass = new EnableQCoreClass(ROOT_PATH . 'Templates/' . $language, 'keep');
