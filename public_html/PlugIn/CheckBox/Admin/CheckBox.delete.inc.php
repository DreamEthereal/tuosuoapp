...
$SQL = ' SELECT optionNameFile,createDate FROM ' . QUESTION_CHECKBOX_TABLE . ' WHERE questionID=\'' . $questionID . '\'';
...
$SQL = ' DELETE FROM ' . QUESTION_CHECKBOX_TABLE . ' WHERE questionID=\'' . $questionID . '\'';
$DB->query($SQL);
