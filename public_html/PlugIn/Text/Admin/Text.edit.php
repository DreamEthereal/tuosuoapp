...
if (($_POST['Action'] == 'AddTextSubmit') || ($_POST['Action'] == 'AddTextOver')) {
	...
	writetolog($lang['modi_text_question'] . ':' . $questionName);

	if ($_POST['Action'] == 'AddTextSubmit') {
		$nextURL = _getnexturl($_POST['surveyID'], $_POST['questionID'], $_POST['orderByID']);

		if ($nextURL == '') {
			_showmessage($lang['modi_text_question'] . ':' . $questionName, true, $_POST['questionID']);
		}
		else {
			_showsucceed($lang['modi_text_question'] . ':' . $questionName, $nextURL);
		}
	}
	else {
		_showmessage($lang['modi_text_question'] . ':' . $questionName, true, $_POST['questionID']);
...
$EnableQCoreClass->setTemplateFile('TextEditFile', 'TextModi.html');
