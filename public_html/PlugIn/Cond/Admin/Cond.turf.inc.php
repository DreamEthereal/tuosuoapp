...
foreach ($theCombArray as $thisComb) {
	...
	foreach ($theComb as $question_yesnoID) {
		$comboName .= qnospecialchar($YesNoListArray[$questionID][$question_yesnoID]['optionName']) . '<br/>&nbsp;';
		$comboSQL .= ' FIND_IN_SET(\'' . $question_yesnoID . '\',b.option_' . $questionID . ') OR ';
	}
