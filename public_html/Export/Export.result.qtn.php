...
if ($_POST['Action'] == 'ExportDataSubmit') {
	...
	case 1:
	default:
		$ResultList = export($_POST['surveyID'], base64_decode($_SESSION['dataSQL']));
		break;

	case 2:
		if (0 < count($_POST['exportQtnList'])) {
			$ResultList = export($_POST['surveyID'], base64_decode($_SESSION['dataSQL']), $_POST['exportQtnList']);
		}

		break;
	}
	// print_r($_SESSION['dataSQL']);
	// exit();
