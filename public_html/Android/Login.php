	...
	if (!$Login_Row) {
		...
		if ($passWord != $Login_Row['passWord']) {
			...
			if ($_POST['loginURL'] != '') {
				...
				exit('true######' . ROOT_PATH . 'Android/InputIndex.php');
			}
		}
	}
}
